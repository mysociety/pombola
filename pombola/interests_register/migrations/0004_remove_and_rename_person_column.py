...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('interests_register_entry', 'person_id')
        db.rename_column('interests_register_entry', 'new_person_id', 'person_id')
    ...
    models = {
        ...
        u'interests_register.entry': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'interests_register_entries'", 'to': u"orm['core.PopoloPerson']", 'null': 'True'}),

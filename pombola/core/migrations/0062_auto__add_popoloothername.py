...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PopoloOtherName'
        db.create_table(u'core_popoloothername', (
            (u'othername_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['popolo.OtherName'], unique=True, primary_key=True)),
            ('name_to_use', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('family_name', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('given_name', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('additional_name', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('honorific_prefix', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('honorific_suffix', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
        ))
        db.send_create_signal(u'core', ['PopoloOtherName'])


    def backwards(self, orm):
        # Deleting model 'PopoloOtherName'
        db.delete_table(u'core_popoloothername')

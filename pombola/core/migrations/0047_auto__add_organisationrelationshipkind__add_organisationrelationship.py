...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrganisationRelationshipKind'
        db.create_table('core_organisationrelationshipkind', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('core', ['OrganisationRelationshipKind'])

        # Adding model 'OrganisationRelationship'
        db.create_table('core_organisationrelationship', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('organisation_a', self.gf('django.db.models.fields.related.ForeignKey')(related_name='org_rels_as_a', to=orm['core.Organisation'])),
            ('organisation_b', self.gf('django.db.models.fields.related.ForeignKey')(related_name='org_rels_as_b', to=orm['core.Organisation'])),
            ('kind', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.OrganisationRelationshipKind'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('core', ['OrganisationRelationship'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'OrganisationRelationshipKind'
        db.delete_table('core_organisationrelationshipkind')

        # Deleting model 'OrganisationRelationship'
        db.delete_table('core_organisationrelationship')
    ...
    models = {
        ...
        'core.organisationrelationship': {
            'Meta': {'object_name': 'OrganisationRelationship'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.OrganisationRelationshipKind']"}),
            'organisation_a': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'org_rels_as_a'", 'to': "orm['core.Organisation']"}),
            'organisation_b': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'org_rels_as_b'", 'to': "orm['core.Organisation']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'core.organisationrelationshipkind': {
        ...
        'scorecards.category': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 12, 49, 24, 334951)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 12, 49, 24, 335076)', 'auto_now': 'True', 'blank': 'True'})
        },
        'scorecards.entry': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 12, 49, 24, 335514)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 12, 49, 24, 335536)', 'auto_now': 'True', 'blank': 'True'})
        }
    }

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person._summary_rendered'
        db.add_column('core_person', '_summary_rendered', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Person.summary'
        db.add_column('core_person', 'summary', self.gf('markitup.fields.MarkupField')(default='', no_rendered_field=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person._summary_rendered'
        db.delete_column('core_person', '_summary_rendered')

        # Deleting field 'Person.summary'
        db.delete_column('core_person', 'summary')
    ...
    models = {
        ...
        'core.contact': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 2, 13, 23, 17, 821957)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 2, 13, 23, 17, 821970)', 'auto_now': 'True', 'blank': 'True'}),

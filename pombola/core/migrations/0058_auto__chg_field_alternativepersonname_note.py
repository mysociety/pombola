...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AlternativePersonName.note'
        db.alter_column(u'core_alternativepersonname', 'note', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'AlternativePersonName.note'
        db.alter_column(u'core_alternativepersonname', 'note', self.gf('django_date_extensions.fields.ApproximateDateField')(max_length=10))

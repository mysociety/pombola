...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Place.organisation'
        db.delete_column(u'core_place', 'organisation_id')

        # Deleting field 'ParliamentarySession.house'
        db.delete_column(u'core_parliamentarysession', 'house_id')


        # Changing field 'ParliamentarySession.new_house'
        db.alter_column(u'core_parliamentarysession', 'new_house_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PopoloOrganization']))
        # Deleting field 'OrganisationRelationship.organisation_a'
        db.delete_column(u'core_organisationrelationship', 'organisation_a_id')

        # Deleting field 'OrganisationRelationship.organisation_b'
        db.delete_column(u'core_organisationrelationship', 'organisation_b_id')


        # Changing field 'OrganisationRelationship.organization_b'
        db.alter_column(u'core_organisationrelationship', 'organization_b_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PopoloOrganization']))

        # Changing field 'OrganisationRelationship.organization_a'
        db.alter_column(u'core_organisationrelationship', 'organization_a_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PopoloOrganization']))

    def backwards(self, orm):
        # Adding field 'Place.organisation'
        db.add_column(u'core_place', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Organisation'], null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ParliamentarySession.house'
        raise RuntimeError("Cannot reverse this migration. 'ParliamentarySession.house' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'ParliamentarySession.house'
        db.add_column(u'core_parliamentarysession', 'house',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Organisation']),
                      keep_default=False)


        # Changing field 'ParliamentarySession.new_house'
        db.alter_column(u'core_parliamentarysession', 'new_house_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PopoloOrganization'], null=True))

        # User chose to not deal with backwards NULL issues for 'OrganisationRelationship.organisation_a'
        raise RuntimeError("Cannot reverse this migration. 'OrganisationRelationship.organisation_a' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'OrganisationRelationship.organisation_a'
        db.add_column(u'core_organisationrelationship', 'organisation_a',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='org_rels_as_a', to=orm['core.Organisation']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'OrganisationRelationship.organisation_b'
        raise RuntimeError("Cannot reverse this migration. 'OrganisationRelationship.organisation_b' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'OrganisationRelationship.organisation_b'
        db.add_column(u'core_organisationrelationship', 'organisation_b',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='org_rels_as_b', to=orm['core.Organisation']),
                      keep_default=False)


        # Changing field 'OrganisationRelationship.organization_b'
        db.alter_column(u'core_organisationrelationship', 'organization_b_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.PopoloOrganization']))

        # Changing field 'OrganisationRelationship.organization_a'
        db.alter_column(u'core_organisationrelationship', 'organization_a_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.PopoloOrganization']))
    ...
    models = {
        ...
        u'core.organisationrelationship': {
            ...
            'organization_a': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'org_rels_as_a'", 'to': u"orm['core.PopoloOrganization']"}),
            'organization_b': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'org_rels_as_b'", 'to': u"orm['core.PopoloOrganization']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'core.parliamentarysession': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            'new_house': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.PopoloOrganization']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '200'}),
        ...
        u'core.place': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.PopoloOrganization']", 'null': 'True', 'blank': 'True'}),
        ...
        u'core.popolopersonothername': {
            'Meta': {'object_name': 'PopoloPersonOtherName', '_ormbases': [u'popolo.OtherName']},
            'additional_name': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'family_name': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'given_name': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'honorific_prefix': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),

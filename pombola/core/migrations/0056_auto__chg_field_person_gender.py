...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_person', 'gender', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Person.gender'
        db.alter_column(u'core_person', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.organization'
        db.add_column(u'core_place', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PopoloOrganization'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParliamentarySession.new_house'
        db.add_column(u'core_parliamentarysession', 'new_house',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PopoloOrganization'], null=True),
                      keep_default=False)

        # Adding field 'OrganisationRelationship.organization_a'
        db.add_column(u'core_organisationrelationship', 'organization_a',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_org_rels_as_a', null=True, to=orm['core.PopoloOrganization']),
                      keep_default=False)

        # Adding field 'OrganisationRelationship.organization_b'
        db.add_column(u'core_organisationrelationship', 'organization_b',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_org_rels_as_b', null=True, to=orm['core.PopoloOrganization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.organization'
        db.delete_column(u'core_place', 'organization_id')

        # Deleting field 'ParliamentarySession.new_house'
        db.delete_column(u'core_parliamentarysession', 'new_house_id')

        # Deleting field 'OrganisationRelationship.organization_a'
        db.delete_column(u'core_organisationrelationship', 'organization_a_id')

        # Deleting field 'OrganisationRelationship.organization_b'
        db.delete_column(u'core_organisationrelationship', 'organization_b_id')
    ...
    models = {
        ...
        u'core.organisationrelationship': {
            ...
            'organization_a': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'new_org_rels_as_a'", 'null': 'True', 'to': u"orm['core.PopoloOrganization']"}),
            'organization_b': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'new_org_rels_as_b'", 'null': 'True', 'to': u"orm['core.PopoloOrganization']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'core.parliamentarysession': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            'new_house': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.PopoloOrganization']", 'null': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '200'}),

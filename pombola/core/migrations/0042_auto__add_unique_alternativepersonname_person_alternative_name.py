...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AlternativePersonName', fields ['person', 'alternative_name']
        db.create_unique('core_alternativepersonname', ['person_id', 'alternative_name'])


    def backwards(self, orm):

        # Removing unique constraint on 'AlternativePersonName', fields ['person', 'alternative_name']
        db.delete_unique('core_alternativepersonname', ['person_id', 'alternative_name'])
    ...
    models = {
        ...
        'scorecards.category': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 14, 23, 22, 631264)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 14, 23, 22, 631294)', 'auto_now': 'True', 'blank': 'True'})
        },
        'scorecards.entry': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 14, 23, 22, 631881)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 14, 23, 22, 631904)', 'auto_now': 'True', 'blank': 'True'})
        }
    }

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PopoloMembership'
        db.create_table(u'core_popolomembership', (
            (u'membership_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['popolo.Membership'], unique=True, primary_key=True)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Place'], null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PositionTitle'], null=True, blank=True)),
            ('subtitle', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ...
            ('sorting_start_date_high', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
            ('sorting_end_date_high', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
        ))
        db.send_create_signal(u'core', ['PopoloMembership'])

        # Adding model 'PopoloPerson'
        db.create_table(u'core_popoloperson', (
            (u'person_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['popolo.Person'], unique=True, primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=200)),
            ('hidden', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('can_be_featured', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'core', ['PopoloPerson'])

        # Adding model 'PopoloOrganization'
        db.create_table(u'core_popoloorganization', (
            (u'organization_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['popolo.Organization'], unique=True, primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=200)),
            ...
            (u'_summary_rendered', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'core', ['PopoloOrganization'])


    def backwards(self, orm):
        # Deleting model 'PopoloMembership'
        db.delete_table(u'core_popolomembership')

        # Deleting model 'PopoloPerson'
        db.delete_table(u'core_popoloperson')

        # Deleting model 'PopoloOrganization'
        db.delete_table(u'core_popoloorganization')

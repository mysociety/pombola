...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Position.sorting_end_date'
        db.add_column('core_position', 'sorting_end_date', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'Position.sorting_start_date'
        db.add_column('core_position', 'sorting_start_date', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Position.sorting_end_date'
        db.delete_column('core_position', 'sorting_end_date')

        # Deleting field 'Position.sorting_start_date'
        db.delete_column('core_position', 'sorting_start_date')
    ...
    models = {
        ...
        'core.contact': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 1, 17, 16, 10, 837661)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 1, 17, 16, 10, 837822)', 'auto_now': 'True', 'blank': 'True'}),

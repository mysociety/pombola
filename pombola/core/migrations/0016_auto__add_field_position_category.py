...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_position', 'category', self.gf('django.db.models.fields.CharField')(default='other', max_length=20), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Position.category'
        db.delete_column('core_position', 'category')
    ...
    models = {
        ...
        'core.contact': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 14, 28, 42, 928794)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 14, 28, 42, 928921)', 'auto_now': 'True', 'blank': 'True'}),

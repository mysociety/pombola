...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.new_speaker'
        db.add_column(u'hansard_entry', 'new_speaker',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='hansard_entries', null=True, to=orm['core.PopoloPerson']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.new_speaker'
        db.delete_column(u'hansard_entry', 'new_speaker_id')

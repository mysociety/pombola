...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alias.new_person'
        db.add_column(u'hansard_alias', 'new_person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PopoloPerson'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alias.new_person'
        db.delete_column(u'hansard_alias', 'new_person_id')

...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        migrate_generic_foreign_key(orm, 'budgets.Budget')
    ...
    models = {
        u'budgets.budget': {
            'Meta': {'ordering': "('-budget_session__date_start', 'budget_session__name', 'name')", 'unique_together': "(('content_type', 'object_id', 'name', 'budget_session'),)", 'object_name': 'Budget'},
    ...
    complete_apps = ['core', 'popolo', 'budgets']
    symmetrical = True

...
# South Africa WriteInPublic configuration
WRITEINPUBLIC_URL = config.get('WRITEINPUBLIC_URL')
WRITEINPUBLIC_USERNAME = config.get('WRITEINPUBLIC_USERNAME')
WRITEINPUBLIC_API_KEY = config.get('WRITEINPUBLIC_API_KEY')
WRITEINPUBLIC_INSTANCE_ID = config.get('WRITEINPUBLIC_INSTANCE_ID')

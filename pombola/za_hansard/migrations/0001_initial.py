    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house', models.CharField(db_index=True, max_length=1, choices=[
                 (b'N', b'National Assembly'), (b'C', b'National Council of Provinces')])),
                ('text', models.TextField()),
                ('processed_code', models.IntegerField(default=0, db_index=True,
                                                       choices=[(0, b'pending'), (1, b'OK'), (2, b'HTTP error')])),
                ...
                ('sayit_section', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, blank=True,
                                                    to='speeches.Section', help_text=b'Associated Sayit section object, if imported', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house', models.CharField(db_index=True, max_length=1, choices=[
                 (b'N', b'National Assembly'), (b'C', b'National Council of Provinces')])),
                ('answer_type', models.CharField(max_length=1, choices=[
                 (b'O', b'Oral Answer'), (b'W', b'Written Answer')])),
                ('date', models.DateField()),
                ('year', models.IntegerField(db_index=True)),
        ...
        migrations.AlterUniqueTogether(
            name='questionpaper',
            unique_together=set(
                [('year', 'issue_number', 'house', 'parliament_number')]),
        ),
        migrations.AddField(
            model_name='question',
            name='paper',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.SET_NULL, to='za_hansard.QuestionPaper', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='question',
            name='sayit_section',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, blank=True,
                                    to='speeches.Section', help_text=b'Associated Sayit section object, if imported', null=True),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            ...
            unique_together=set([('written_number', 'house', 'year'), ('dp_number', 'house', 'year'), (
                'oral_number', 'house', 'year'), ('president_number', 'house', 'year'), ('id_number', 'house', 'year')]),
        ),
        migrations.AddField(

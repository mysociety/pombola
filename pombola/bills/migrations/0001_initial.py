...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bills_bill', (
            ...
            ('parliamentary_session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ParliamentarySession'])),
            ('sponsor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bills_sponsored', to=orm['core.Person'])),
        ))

...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Bill.sponsor'
        db.alter_column(u'bills_bill', 'sponsor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PopoloPerson']))

    def backwards(self, orm):

        # Changing field 'Bill.sponsor'
        db.alter_column(u'bills_bill', 'sponsor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.PopoloPerson']))
    ...
    models = {
        u'bills.bill': {
            ...
            'sponsor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bills_sponsored'", 'to': u"orm['core.PopoloPerson']"}),

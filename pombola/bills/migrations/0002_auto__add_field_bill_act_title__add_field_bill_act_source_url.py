...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.act_title'
        db.add_column(u'bills_bill', 'act_title',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bill.act_source_url'
        db.add_column(u'bills_bill', 'act_source_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bill.act_title'
        db.delete_column(u'bills_bill', 'act_title')

        # Deleting field 'Bill.act_source_url'
        db.delete_column(u'bills_bill', 'act_source_url')
    ...
    models = {
        u'bills.bill': {
            ...
            'sponsor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bills_sponsored'", 'to': u"orm['core.Person']"}),

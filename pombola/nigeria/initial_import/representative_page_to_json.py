...
def process(filename):
    ...
    raw_data['name'] = content.find("p", "newtitle").get_text()
    ...
    data['positions'].append({
        ...
        "place":        raw_data["Member's District"],
        "start_date":   raw_data["Date of Asumption"],
    ...
    for committee in raw_data["Committees Membership"].split("\n"):

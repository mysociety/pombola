...
from pombola.core.migration_helpers import migrate_generic_foreign_key
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        migrate_generic_foreign_key(orm, 'tasks.Task')
    ...
    models = {
        ...
        u'tasks.task': {
            'Meta': {'ordering': "['-priority', 'attempt_count', 'defer_until']", 'object_name': 'Task'},
            'attempt_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tasks.TaskCategory']"}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tasks.taskcategory': {
            'Meta': {'ordering': "['-priority', 'slug']", 'object_name': 'TaskCategory'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['core', 'popolo', 'tasks']
    symmetrical = True

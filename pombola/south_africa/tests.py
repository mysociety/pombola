...
class SAPersonDetailViewTest(TestCase):
    ...
    def test_generation_of_interests_table(self):
        ...
        expected = {1:{'name':u'2013','categories':{1:{'name':u'Test Category','headings':[u'Field1',u'Field2',u'Field3'],'headingindex':{u'Field1':0,u'Field2':1,u'Field3':2},'headingcount':4,'entries':[[u'Value1',u'Value2',''],[u'Value3','',u'Value4']]},2:{'name':u'Test Category 2','headings':[u'Field4'],'headingindex':{u'Field4':0},'headingcount':2,'entries':[[u'Value5']]}}}}

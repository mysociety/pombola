...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageContent.description'
        db.add_column('spinner_imagecontent', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageContent.description'
        db.delete_column('spinner_imagecontent', 'description')

...
./bin/run_management_command za_hansard_pmg_api_scraper --scrape --save-json --commit
./bin/run_management_command south_africa_import_committee_appearances --delete-existing --commit

...
apt-get install -y -qq postgresql postgis postgresql-9.1-postgis libpq-dev python-gdal python-dev python-pip python-virtualenv libxml2-dev libxslt1-dev openjdk-7-jre-headless libjpeg-dev >/dev/null

...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Change all empty end_dates to be 'future'"
        for position in orm.Position.objects.filter(end_date=''):
            position.end_date = 'future'
            position.save()
    
    def backwards(self, orm):
        "No backward method is needed"
        pass
    ...
    models = {
        ...
        'core.contact': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 11, 44, 35, 898095)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 11, 44, 35, 899784)', 'auto_now': 'True', 'blank': 'True'}),

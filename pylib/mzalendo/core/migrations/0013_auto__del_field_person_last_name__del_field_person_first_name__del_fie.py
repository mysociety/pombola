...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_person', 'last_name')

        # Deleting field 'Person.first_name'
        db.delete_column('core_person', 'first_name')

        # Deleting field 'Person.middle_names'
        db.delete_column('core_person', 'middle_names')

        # Changing field 'Person.legal_name'
        db.alter_column('core_person', 'legal_name', self.gf('django.db.models.fields.CharField')(max_length=300))
    
    
    def backwards(self, orm):
        
        # Adding field 'Person.last_name'
        db.add_column('core_person', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Person.first_name'
        db.add_column('core_person', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Person.middle_names'
        db.add_column('core_person', 'middle_names', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Changing field 'Person.legal_name'
        db.alter_column('core_person', 'legal_name', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True))
    ...
    models = {
        ...
        'core.contact': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 24, 12, 19, 36, 237898)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 24, 12, 19, 36, 237934)', 'auto_now': 'True', 'blank': 'True'}),

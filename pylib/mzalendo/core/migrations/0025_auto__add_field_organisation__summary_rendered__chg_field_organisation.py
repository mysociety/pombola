...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organisation._summary_rendered'
        db.add_column('core_organisation', '_summary_rendered', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'Organisation.summary'
        db.alter_column('core_organisation', 'summary', self.gf('markitup.fields.MarkupField')(no_rendered_field=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Organisation._summary_rendered'
        db.delete_column('core_organisation', '_summary_rendered')

        # Changing field 'Organisation.summary'
        db.alter_column('core_organisation', 'summary', self.gf('django.db.models.fields.TextField')(blank=True))
    ...
    models = {
        ...
        'core.contact': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 4, 13, 39, 19, 497012)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 4, 13, 39, 19, 497304)', 'auto_now': 'True', 'blank': 'True'}),

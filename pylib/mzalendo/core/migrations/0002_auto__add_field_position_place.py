...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Position.place'
        db.add_column('core_position', 'place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Place'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Position.place'
        db.delete_column('core_position', 'place_id')

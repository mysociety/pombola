...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_contact', (
            ('kind', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ContactKind'])),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ContactKind'
        db.delete_table('core_contactkind')

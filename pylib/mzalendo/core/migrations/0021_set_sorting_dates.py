...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "recalculate all the positions to set the sorting dates"
        for position in orm.Position.objects.all():

            start = repr( position.start_date ) if position.start_date else ''
            end   = repr( position.end_date   ) if position.end_date   else ''

            position.sorting_start_date =        start or '0000-00-00'
            position.sorting_end_date   = end or start or '0000-00-00'
            position.save()
    ...
    models = {
        ...
        'core.contact': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 1, 17, 21, 13, 755161)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 1, 17, 21, 13, 755204)', 'auto_now': 'True', 'blank': 'True'}),

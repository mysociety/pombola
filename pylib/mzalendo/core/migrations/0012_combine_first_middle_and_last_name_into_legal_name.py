...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Combine all the name parts into one"
        for person in orm.Person.objects.all():
            legal_name = " ".join( [person.first_name, person.middle_names, person.last_name] )
            legal_name = re.sub('\s+', ' ', legal_name)
            person.legal_name = legal_name
            person.save()
    
    def backwards(self, orm):
        "A backwards migration is not possible as we'd be guessing about the name"
        raise Exception("Cannot migrate backwards - can't work out original name components")
    ...
    models = {
        ...
        'core.contact': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 24, 12, 4, 45, 445945)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 24, 12, 4, 45, 446030)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.person': {
            ...
            'legal_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '300', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.middle_names'
        db.alter_column('core_person', 'middle_names', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))

        # Changing field 'Place.organisation'
        db.alter_column('core_place', 'organisation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Organisation'], null=True, blank=True))

        # Changing field 'Place.location'
        db.alter_column('core_place', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Person.middle_names'
        db.alter_column('core_person', 'middle_names', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Place.organisation'
        db.alter_column('core_place', 'organisation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Organisation'], null=True))

        # Changing field 'Place.location'
        db.alter_column('core_place', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Source.last_processed'
        db.delete_column('hansard_source', 'last_processed')

        # Adding field 'Source.last_processing_attempt'
        db.add_column('hansard_source', 'last_processing_attempt', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Source.last_processing_success'
        db.add_column('hansard_source', 'last_processing_success', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Source.last_processed'
        db.add_column('hansard_source', 'last_processed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Source.last_processing_attempt'
        db.delete_column('hansard_source', 'last_processing_attempt')

        # Deleting field 'Source.last_processing_success'
        db.delete_column('hansard_source', 'last_processing_success')
    ...
    models = {
        ...
        'core.contact': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 17, 17, 32, 40, 479761)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 17, 17, 32, 40, 479800)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'hansard.entry': {
            ...
            'speaker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Person']", 'null': 'True', 'blank': 'True'}),

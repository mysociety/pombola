...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sitting.venue'
        db.add_column('hansard_sitting', 'venue', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['hansard.Venue']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sitting.venue'
        db.delete_column('hansard_sitting', 'venue_id')
    ...
    models = {
        ...
        'core.contact': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 18, 15, 20, 56, 47870)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 18, 15, 20, 56, 47907)', 'auto_now': 'True', 'blank': 'True'}),

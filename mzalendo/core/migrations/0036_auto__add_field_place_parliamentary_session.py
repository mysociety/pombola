...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.parliamentary_session'
        db.add_column('core_place', 'parliamentary_session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ParliamentarySession'], null=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Place.parliamentary_session'
        db.delete_column('core_place', 'parliamentary_session_id')
    ...
    models = {
        ...
        'scorecards.category': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 21, 16, 38, 48, 116118)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 21, 16, 38, 48, 116146)', 'auto_now': 'True', 'blank': 'True'})
        },
        'scorecards.entry': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 21, 16, 38, 48, 116700)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 21, 16, 38, 48, 116722)', 'auto_now': 'True', 'blank': 'True'})
        }
    }

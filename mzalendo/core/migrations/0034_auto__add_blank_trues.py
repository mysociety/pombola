...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InformationSource.entered'
        db.alter_column('core_informationsource', 'entered', self.gf('django.db.models.fields.BooleanField')(blank=True))
        ...
        # Changing field 'PositionTitle.requires_place'
        db.alter_column('core_positiontitle', 'requires_place', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):

        # Changing field 'InformationSource.entered'
        db.alter_column('core_informationsource', 'entered', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Person.can_be_featured'
        db.alter_column('core_person', 'can_be_featured', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'PositionTitle.requires_place'
        db.alter_column('core_positiontitle', 'requires_place', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'scorecards.category': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 13, 12, 10, 990939)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 13, 12, 10, 990970)', 'auto_now': 'True', 'blank': 'True'})
        },
        'scorecards.entry': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 13, 12, 10, 991545)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 13, 12, 10, 991568)', 'auto_now': 'True', 'blank': 'True'})
        }
    }

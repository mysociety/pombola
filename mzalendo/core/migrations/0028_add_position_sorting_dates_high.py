...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Position.sorting_start_date_high'
        db.add_column('core_position', 'sorting_start_date_high', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Position.sorting_start_date_high'
        db.delete_column('core_position', 'sorting_start_date_high')

        # Deleting field 'Position.sorting_end_date_high'
        db.delete_column('core_position', 'sorting_end_date_high')
    ...
    models = {
        ...
        'core.contact': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 6, 18, 16, 58, 480387)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'scorecards.category': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 6, 18, 16, 58, 478068)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 6, 18, 16, 58, 478119)', 'auto_now': 'True', 'blank': 'True'})
        },
        'scorecards.entry': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 6, 18, 16, 58, 478813)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 6, 18, 16, 58, 478841)', 'auto_now': 'True', 'blank': 'True'})
        }
    }

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommentWithTitle'
        db.create_table('mz_comments_commentwithtitle', (
        ...
        db.send_create_signal('mz_comments', ['CommentWithTitle'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CommentWithTitle'
        db.delete_table('mz_comments_commentwithtitle')

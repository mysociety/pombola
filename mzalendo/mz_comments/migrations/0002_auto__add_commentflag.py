...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mz_comments_commentflag', (
            ('commentflag_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['comments.CommentFlag'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('mz_comments', ['CommentFlag'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CommentFlag'
        db.delete_table('mz_comments_commentflag')
    ...
    models = {
        ...
        'mz_comments.commentflag': {
            'Meta': {'object_name': 'CommentFlag', '_ormbases': ['comments.CommentFlag']},
            'commentflag_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['comments.CommentFlag']", 'unique': 'True', 'primary_key': 'True'})
        },
        'mz_comments.commentwithtitle': {
            'Meta': {'object_name': 'CommentWithTitle', '_ormbases': ['comments.Comment']},

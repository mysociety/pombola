...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.flag_count'
        db.add_column('comments2_comment', 'flag_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Comment.flag_count'
        db.delete_column('comments2_comment', 'flag_count')

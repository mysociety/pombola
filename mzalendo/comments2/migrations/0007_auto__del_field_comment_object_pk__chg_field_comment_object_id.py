...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Comment.object_pk'
        db.delete_column('comments2_comment', 'object_pk')

        # Changing field 'Comment.object_id'
        db.alter_column('comments2_comment', 'object_id', self.gf('django.db.models.fields.IntegerField')(default=1))


    def backwards(self, orm):
        
        # Adding field 'Comment.object_pk'
        db.add_column('comments2_comment', 'object_pk', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Changing field 'Comment.object_id'
        db.alter_column('comments2_comment', 'object_id', self.gf('django.db.models.fields.IntegerField')(null=True))

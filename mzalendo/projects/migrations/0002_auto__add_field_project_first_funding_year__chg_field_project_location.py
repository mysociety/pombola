...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.first_funding_year'
        db.add_column('projects_project', 'first_funding_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'Project.location'
        db.alter_column('projects_project', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Project.first_funding_year'
        db.delete_column('projects_project', 'first_funding_year')

        # Changing field 'Project.location'
        from django.contrib.gis.geos import Point
        db.alter_column('projects_project', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(default=Point(0,0, srid=4326)))
    ...
    models = {
        ...
        'core.contact': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 52, 27, 197781)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 52, 27, 197813)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'projects.project': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 52, 27, 365826)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 52, 27, 365925)', 'auto_now': 'True', 'blank': 'True'})
        },
        'scorecards.category': {
            'Meta': {'ordering': "('name',)", 'object_name': 'Category'},
            '_description_rendered': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 52, 27, 195474)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 52, 27, 195525)', 'auto_now': 'True', 'blank': 'True'})
        },
        'scorecards.entry': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 52, 27, 196242)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 52, 27, 196272)', 'auto_now': 'True', 'blank': 'True'})
        }
    }
